                                            ...
                                            <div className="col s12 m12 l6 listing-card">
                                                <div className="card" key={pet.pet_data.pet_id}>
                                                    ...
                                                    <div class="card-action">
                                                        <Link className="truncate" onClick={() => window.scrollTo(0, 0)} to={"/listings/" + pet.pet_data.type + "/profile/FF-" + pet.pet_data.pet_id}><i className="material-icons right">arrow_forward</i>{pet.pet_data.name}'s PROFILE</Link>
                                                    </div>
                                                </div>
                                            </div>
                                        )}
